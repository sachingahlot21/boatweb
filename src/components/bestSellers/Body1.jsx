  ...
  return (
    <>
      ...
      <div className='md:w-screeen no-scrollbar md:h-72 md:mt-9 mt-7 h-[220px] overflow-x-scroll overflow-y-hidden md:overflow-hidden'>
        <div className='md:w-screen md:h-10 md:pl-10 pl-5'>
        ...
        <div className='md:w-screen md:h-56 w-[900px] h-[280px]'>

          <div className='md:w-[890px] md:h-[180px]   md:m-auto ml-5 md:mt-2 mt-2 flex justify-between'>
            <Link
