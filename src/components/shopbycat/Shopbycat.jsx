...
function Main() {
  return (
    <>
      ...
      <div className='md:w-[1375px] w-screen  overflow-x-scroll overflow-y-hidden    h-[315px] md:h-[209px] mt-6 no-scrollbar '>

      <div className='w-[786px] h-[35px] md:pl-10 pl-5 md:mb-4 mb-1'>
        ...
        <div className='overflow-x-scroll md:overflow-x-scroll overflow-y-hidden md:overflow-y-hidden w-[786px] md:w-[2000px]  h-[90%] md:h-[80%] flex  flex-wrap md:flex-nowrap gap-3 p-5 md:p-0 md:pl-7 no-scrollbar '>
