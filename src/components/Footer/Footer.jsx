...
function Footer() {
  ...
  return (
    <>
      <div className='md:w-[93vw] flex  flex-col w-[85vw] md:mr-[10px] mr-[20px] h-[300px] md:h-[231px] bg-[rgb(231,240,245)] ml-10 overflow-hidden'>
       
          <div className='md:w-[90vw] w-[90vw] md:h-[55px] m-auto mb-1 mt-[22px]  overflow-hidden  '>
           
            <div className='flex  w-[60%] md:w-[40%] h-[55px] m-auto'>
              <div className='w-[50%] h-[55px]  m-auto pt-3 '><p className='text-l font-bold tracking-normal'>Let's get social</p></div>
              <div className='w-[50%] h-[55px] flex justify-between'>
          ...
          <div className='md:w-[90vw] overflow-y-hidden md:h-[94px] w-[70vw] h-[130px]  m-auto my-[8px]   '>
            ...
            <div className='md:w-[80%]  w-[100%] m-auto md:h-[80%] h-[95px]  md:mt-0 mt:2 flex flex-wrap text-[rgb(180,196,206)] md:text:xs  text-sm  whitespace-normal text-center bg-y'>
